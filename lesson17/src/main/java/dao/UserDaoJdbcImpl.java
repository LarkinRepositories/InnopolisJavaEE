...
//    private static final ConnectionManagerJdbcImpl CONNECTION_MANAGER_JDBC = ConnectionManagerJdbcImpl.getInstance();
    ...
    public static final String INSERT_INTO_USERS = "INSERT INTO PUBLIC.USERS (NAME, BIRTHDAY, LOGIN_ID, CITY, EMAIL, DESCRIPTION) VALUES (?, ?, ?, ?, ?, ?)";
    public static final String GET_USER_BY_ID = "SELECT * FROM PUBLIC.USERS WHERE ID = ?";
    public static final String UPDATE_USER_BY_ID = "UPDATE PUBLIC.USERS set NAME=?, BIRTHDAY = ?, LOGIN_ID = ?, CITY = ?, EMAIL=?, DESCRIPTION = ? WHERE id = ?";
